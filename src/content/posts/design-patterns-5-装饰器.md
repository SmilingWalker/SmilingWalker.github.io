...
先把业务摊开。双 12 之后，CloudShop 的计价引擎跑起来了：满减、会员折扣、平台券、红包各就各位，互斥择优也上了线。但运营的玩法没有停的意思，新需求单上有两件事。一件是**店铺券**：头部商家要做店铺级促销，"满 200 减 20"，成本商家自己掏——这是平台电商的标配玩法，淘宝的店铺优惠券就是它。另一件是个 **A/B 实验**：凌晨时段对 PLUS 会员试开"额外 97 折"，跑两周看拉夜单的效果，到期下线。

这两件事的共同点，比它们本身更重要。优惠在计价里不是一堆平行的减法，是**一层压一层的层叠**：每一层的成本出自不同的口袋（平台补贴、商家营销费、用户账户里的红包余额），而每一层拿到的，都是上一层算完的价。先 95 折再减 20 元券，和先减券再打折，差出来的就是真金白银——**顺序就是钱**，这话在第 1 篇说过，在这里它升级成了主要矛盾。于是新需求的本质浮出来：不是"多两种优惠"，是**往计价链中间插两层**——而且 A/B 实验那两层，两周后还要原样拆走。
