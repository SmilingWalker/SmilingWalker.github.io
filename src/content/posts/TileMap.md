...
pinned: false
description: ""
tags: [OpenLayers,XYZ,TMS,WMTS,WEBGIS]
category: WEBGIS
draft: false
---
...
> XYZ: Adds the following standards to WMTS standards - An X and Y numbering scheme; PNG images for tiles; Images are served through a REST API, with a URL like [https://.../Z/X/Y.png](https://.../Z/X/Y.png), where Z is the zoom level, and X and Y identify the tile.
...
+ 添加了 X Y 规范
+ 添加了 PNG 地图格式
+ 图片保存在Web 服务器内，并且请求方式为 `https://.../Z/X/Y.png`，Z 为缩放级别，X，Y 标记图片的位置、
**图片命名规则**
