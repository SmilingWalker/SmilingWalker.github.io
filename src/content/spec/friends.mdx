...
export const site = {
  name: "Tech Notes",
  desc: "记录技术调研与工程实践笔记",
  url: "https://SmilingWalker.github.io",
  avatar: "https://SmilingWalker.github.io/avatar.jpg",
  email: "",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">在 GitHub 联系我：<a href="https://github.com/SmilingWalker" target="_blank" class="text-(--primary) underline">github.com/SmilingWalker</a></p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">把下面的申请模板填好后，通过 GitHub 联系我</p>
